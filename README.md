<p align="center"><img src="https://github.com/Rjshamim/IF/blob/main/images/logo.png" width="400px" height="150px" alt="ddos"></p>

<h1 align="center">ifDDoS - DDoS Attack Script With 56 Methods</h1>
<em><h5 align="center">(Programming Language - Python 3)</h5></em>

<p align="center">
<a href="#"><img alt="if-DDoS forks" src="https://img.shields.io/github/forks/MatrixTM/MHDDoS?style=for-the-badge"></a>
<a href="#"><img alt="if-DDoS last commit (main)" src="https://img.shields.io/github/last-commit/MatrixTM/MHDDoS/main?color=green&style=for-the-badge"></a>
...
You can download it from [GitHub Releases](https://github.com/rjshamim/ifddos/releases)
...
You can read it from [GitHub Wiki](https://github.com/rjshamim/ifddos)

**Clone and Install Script**

```shell script
git clone https://github.com/rjshamim/ifddos.git
cd MHDDoS
...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/rjshamim/ifddos.git && cd ifddos* && pip3 install -r requirements.txt
```

[python3]: https://python.org 'Python3'
[github issues]: https://github.com/rjshamim/ifddos/issues 'enter'
